...
/** regenerateChart GET /api/chart/regenerate */
export async function regenerateChartUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.regenerateChartUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/chart/regenerate', {
    method: 'GET',
    params: {
      ...params,
    },
...
/** updateChartByGen POST /api/chart/update/gen */
export async function updateChartByGenUsingPost(
  body: API.ChartUpdateRequest,
  options?: { [key: string]: any },
) {
