...
/** deleteUserBatch POST /api/user/delete/ids */
export async function deleteUserBatchUsingPost(
  body: API.UsersDeleteRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/user/delete/ids', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 用户忘记密码 POST /api/user/forget/password */
export async function forgetPasswordUsingPost(
  body: API.UserEditPasswordRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/user/forget/password', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** sendCaptcha POST /api/user/sendCaptcha */
export async function sendCaptchaUsingPost(
  body: API.UserSendCaptchaRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseString_>('/api/user/sendCaptcha', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
